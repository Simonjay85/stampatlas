...
export default function AdminImports() {
  ...
  const pendingSummary = trpc.externalImports.pendingSummary.useQuery(undefined, { enabled: !!user && user.role === "admin" });
  const utils = trpc.useUtils();
  const invalidateImports = () => { utils.externalImports.list.invalidate(); utils.externalImports.pendingSummary.invalidate(); };
